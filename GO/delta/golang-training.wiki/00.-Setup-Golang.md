...
## Install Go Path Extension

## Setup Go Module with VSCode

> We should not enable `GO111MODULE=on` globally, due to there are many project'r still using old version.
